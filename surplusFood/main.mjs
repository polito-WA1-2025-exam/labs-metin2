...
const bag3 = new Bag(1, "Regular", "Available", 6 , "medium", establishment3, [food_item5]);
const bag4 = new Bag(1, "Regular", "Available", 20, "medium", establishment4, [food_item6, food_item7, food_item8, food_item9]);
const bag5 = new Bag(1, "Regular", "Available", 20, "medium", establishment5, [food_item10, food_item11, food_item12]);
console.log(bag1);
